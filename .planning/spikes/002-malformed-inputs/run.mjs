...
const cases = [
  ...
  {
    // Exact reviewer shell: the ten-byte key-frame header is present, but
    // its little-endian frame tag declares 100 bytes in the first partition.
    name: "webp-vp8-first-partition-overrun",
